# Démarrage rapide
Prenez le temps de vous installer sur alloé, vous lirez les détails plus tard ! 
Pourquoi un petit guide de démarrage rapide ? Parce qu’alloé, c’est en fait deux parties : une partie **Write** pour tenir vos blogs, et une partie **Social** pour interagir avec les autres, parler de tout et de rien, commenter la publication d’un texte, etc…

Les réseaux sociaux fédérés, c’est une autre façon d’aborder les choses, et parfois c’est quand même mieux avec un petit guide.
...
:::tip
Cette étape sera à reproduire pour chaque nouveau blog dont vous voudrez partager les publications sur **alloé, Social**.  C’est comme ça ici, vous êtes parfaitement maître de la visibilité de vos blogs ! 
:::
